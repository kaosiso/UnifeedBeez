...
// Example initial chat messages (replace with your data)
const chatMessages: ChatMessageData[] = [
  {
    ...
    content: {
      title: 'Welcome!',
      text: 'Here is your business plan suggestion:',
      plan: {
        name: 'Business Plan',
        label: 'Your Plan',
        price: '£219.2',
        buttonText: 'Upgrade Plan',
        features: ['3 Extra Seats', '2 Extra AI Assistant', '2 Extra Whatsapp Channel'],
      },
    },
  },
];
          ...
          {messages.map((message) => (
            ...
            >
              ...
              {message.type === 'choice' && (
                <div
                  className={`max-w-xl flex flex-col ${
                    message.sender === 'copilot' ? 'items-start' : 'items-end'
                  } space-y-2`}
                >
                  <button
              ...
              {message.type === 'text' && message.text && (
                <div
                  className={`max-w-xl bg-white p-3 rounded-xl shadow-md ${
                    message.sender === 'copilot' ? 'mr-2' : 'ml-2'
                  }`}
                >
                  {message.text}
                </div>
